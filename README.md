...
```bash
curl -fsSL https://raw.githubusercontent.com/herb711/Codalane/main/install.sh -o install.sh
less install.sh
bash install.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/herb711/Codalane/main/install.sh | bash
```
